...
mini(tt,"Data Requests","combined role-gated form; duplicate-buy detection at intake.",first=True)
...
mini(tt,"Intelligence","cross-tool signals, vendor value, Ask Atlas.")
# RIGHT column
